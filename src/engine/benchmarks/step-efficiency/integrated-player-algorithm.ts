...
export function integratedPlayerAlgorithmRef() {
  ...
  return defineAlgorithmRef({ role: "world-execution", id: "integrated-player-diagnostic", version: "11", contractVersion: 11,
...
export function registerIntegratedPlayerAlgorithm(registry = new WorldExecutionAlgorithmRegistry()) {
  ...
  registry.registerDefinition({ role: "world-execution", id: "integrated-player-diagnostic", version: "11", contractVersion: 11,
