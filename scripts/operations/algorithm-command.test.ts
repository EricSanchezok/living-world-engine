...
describe("algorithm command", () => {
  it("lists, describes, validates, and checks the generated catalog", () => {
    ...
    expect(JSON.parse(runAlgorithmCommand(["describe", "world-execution/eager-reference@25"]))).toMatchObject({
      definition: { role: "world-execution", id: "eager-reference", version: "25" },
    });
